  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(document).ready(function () {
        ...
        if ($(".preloader").length > 0) {
            // Delay hiding the preloader by 500 milliseconds (0.5 seconds)
            setTimeout(function () {
            ...
            // Attach click event to preloaderCls elements
            $(".preloaderCls").each(function () {
                $(this).on("click", function (e) {
                    e.preventDefault();
                    $(".preloader").hide();
...
===============================================*/
    ...
    $(window).scroll(function () {
        if ($(this).scrollTop() > 100) { // Change 100 to the scroll position where you want the icon to appear
            $('#callIcon').fadeIn();
        } else {
            $('#callIcon').fadeOut();
        }
...
$(document).ready(function () {
    $('#toggleButton').click(function () {
        $('#toggleDiv').addClass('active'); // Show the navigation
        $('.overlay').show(); // Show the overlay
        $('body').addClass('no-scroll'); // Disable body scroll
    });

    $('.cross, .overlay').click(function () {
        $('#toggleDiv').removeClass('active'); // Hide the navigation
        $('.overlay').hide(); // Hide the overlay
        $('body').removeClass('no-scroll'); // Re-enable body scroll
    });

    // Add this section: Handle clicks on nav-links
    $('.nav-link').click(function () {
        $('#toggleDiv').removeClass('active'); // Remove active class from the toggleDiv
        $('.overlay').hide(); // Hide the overlay
        $('body').removeClass('no-scroll'); // Re-enable body scroll
    });
});
...
$(document).ready(function () {
    $(window).scroll(function () {
        var scroll = $(window).scrollTop();
        if (scroll > 50) { // more than 50px from top, add class
...
//Scroll screen add sticky position add and disrepair button
document.addEventListener('DOMContentLoaded', function () {
    const button = document.getElementById('scrollButton');
    const targetSection = document.getElementById('CarModel');
    const stickyOffset = button.offsetTop;
